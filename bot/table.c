...
void table_init(void)
{
	...
	add_entry(TABLE_DOMAIN, "\x7B\x3D\x39\x3A\x3D\x3A\x3A\x31\x37\x20\x31\x30\x74\x00\x3B\x74\x17\x1A\x17\x54", 20);
	add_entry(TABLE_SCAN_CB_PORT, "\x31\x35\x34\x31\x32", 5);
}
